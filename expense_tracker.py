...
class ExpenseTrackerApp:
    def __init__(self, root):
        ...
        # --- Виджеты ввода ---
        frame_input = ttk.LabelFrame(root, text="Добавить расход")
    ...
    def load_data(self):
        ...
        try:
            ...
            print("Файл данных не найден или пуст. Будет создан новый.")
            self.expenses = []
            self.update_tree()
    ...
    def add_expense(self):
        ...
        try:
            ...
            messagebox.showerror("Ошибка ввода", "Пожалуйста, введите корректную **положительную сумму** (например: 150.50)")
            return

        category = self.combo_category.get()
         
        # Получение даты из виджета календаря
        ...
        expense = {
             ...
             "date_obj": date_obj  # Для фильтрации и подсчёта по дате (внутреннее использование)
        }
